...
DOCKER_DIR="$(pwd)/src"
DOCKER_DIR_VOLUME="$(pwd)/volume"
DOCKER_DIR_APPS=${DOCKER_DIR_APPS:-"$DOCKER_DIR/main"}
DOCKER_DIR_APPS_TEST=${DOCKER_DIR_APPS_TEST:-"$DOCKER_DIR/test"}
DOCKER_FILE_CONFIG=${DOCKER_FILE_CONFIG:-"$DOCKER_DIR_APPS/config/$DOCKER_FILE_NAME_COMPOSE"}
DOCKER_VOLUME=${DOCKER_VOLUME:-"$DOCKER_DIR_VOLUME/main"}
DOCKER_VOLUME_TEST=${DOCKER_VOLUME_TEST:-"$DOCKER_DIR_VOLUME/test"}
DOCKER_DIR_APP_SUB=""
...
function use_dir_app_test() {
  ...
  DOCKER_VOLUME="$DOCKER_VOLUME_TEST"
}
